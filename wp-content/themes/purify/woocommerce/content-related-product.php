...
if ( isset( $theme_options_data['thim_woo_related_product_column'] ) && $theme_options_data['thim_woo_related_product_column'] <> '' ) {
    $column_product = 12 / $theme_options_data['thim_woo_related_product_column'];
}
//

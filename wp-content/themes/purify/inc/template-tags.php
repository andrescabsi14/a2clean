...
if ( !function_exists( 'thim_post_nav' ) ) :
	...
	function thim_post_nav() {
		...
		<nav class="navigation post-navigation" role="navigation">
			<div class="nav-links">
				<?php
				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<span class="meta-nav"><i class="pe-7s-angle-left-circle"></i>
</span>PREVIOUS', 'Previous post link', 'thim' ) );
				next_post_link( '<div class="nav-next">%link</div>', _x( 'Next<span class="meta-nav"><i class="pe-7s-angle-right-circle"></i>
</span>', 'Next post link', 'thim' ) );
				?>
				<div class="clear"></div>
			</div>
			<!-- .nav-links -->
	...
	function thim_posted_on() {
		...
		<div class="article-extra-info">
			<?php if ( isset( $theme_options_data['thim_show_author'] ) && $theme_options_data['thim_show_author'] == 1 ) {
				?>
				<span class="author vcard"><?php echo _e( 'by ', 'thim' ); ?></span><?php printf( '<a href="%1$s" rel="author">%2$s</a>',
...
if ( !function_exists( 'thim_posted_on_single' ) ) :
	...
	function thim_posted_on_single() {
		...
		<div class="article-extra-info">
			...
			if ( isset( $theme_options_data['thim_single_show_author'] ) && $theme_options_data['thim_single_show_author'] == 1 ) {
				if ( class_exists( 'LikeBtnLikeButton' ) ) {
					?>
					<span class="post-like">
					<?php
					echo do_shortcode( '[likebtn identifier="' . get_the_ID() . '" theme="heartcross" dislike_enabled="0" icon_dislike_show="0" tooltip_enabled="0"]' );
					?>
				</span>
				<?php
				}

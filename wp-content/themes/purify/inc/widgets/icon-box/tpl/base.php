...
if ( $instance['icon_type'] == 'font-awesome' ) {
...
else if ( $instance['icon_type'] == 'font-7-stroke' ) {
    ...
    if ( $instance['font_7_stroke_group']['icon'] != 'none' ) {
        ...
        $style = '';
        $style .= ( $instance['color_group']['icon_color'] != '' ) ? 'color:' . $instance['color_group']['icon_color'] . ';' : '';
        $style .= ( $instance['font_7_stroke_group']['icon_size'] != '' ) ? ' font-size:' . $instance['font_7_stroke_group']['icon_size'] . 'px;' : '';
        $html_icon .= '<div class="icon" style="' . $style . '">';
        $html_icon .= '<span class="' . $class . '" ></span>';
        $html_icon .= '</div></div>';
    }
}
else {
...
/* show CONTENT*/
$html_content = $color_desc = $style_color_desc = $color_desc_line = $style_color_desc_line = $class = '';

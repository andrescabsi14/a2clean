...
function tp_register_required_plugins() {
	$plugins = array(
		...
		array(
			...
			'source'             => 'https://downloads.wordpress.org/plugin/siteorigin-panels.2.1.zip', // The plugin source
		...
		array(
			...
			'source'             => 'http://downloads.wordpress.org/plugin/contact-form-7.4.1.1.zip', // The plugin source
		...
		array(
			...
			'source'             => 'https://downloads.wordpress.org/plugin/woocommerce.2.3.7.zip', // The plugin source
		...
		array(
			...
			'source'             => 'https://downloads.wordpress.org/plugin/widget-settings-importexport.1.5.0.zip', // The plugin source
		...
		array(
			'name'               => 'Like Button Voting & Rating', // The plugin name
			'slug'               => 'likebtn-like-button', // The plugin slug (typically the folder name)
			'source'             => 'https://downloads.wordpress.org/plugin/likebtn-like-button.2.1.3.zip', // The plugin source
		...
		array(
			'name'               => 'Testimonials By ThimPress', // The plugin name
			'slug'               => 'thim-testimonials', // The plugin slug (typically the folder name)
			'source'             => get_template_directory() . '/inc/plugins/thim-testimonials.zip', // The plugin source

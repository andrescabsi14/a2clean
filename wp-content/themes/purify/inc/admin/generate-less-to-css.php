...
function generate($fileout, $type, $theme_option_variations) {
    ...
    $css .= $wp_filesystem->get_contents(TP_THEME_DIR . "less/extra.less");
...
//    }
    ...
    if (!$wp_filesystem->put_contents(TP_THEME_DIR . 'css/yith_compare.css', $compare_style, FS_CHMOD_FILE)) {

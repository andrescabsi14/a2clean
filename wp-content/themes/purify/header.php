...
<div id="wrapper-container" class="wrapper-container">
	<div class="content-pusher">
		...
		// Slider Widget
		if ( isset( $theme_options_data['thim_header_position'] ) && $theme_options_data['thim_header_position'] == "header_after_slider" ) {
			dynamic_sidebar( 'banner_header' );
		}
		$class_transparent = '';
		if ( isset( $theme_options_data['thim_show_header_transparent'] ) && $theme_options_data['thim_show_header_transparent'] == 1 ) {
			$class_transparent .= " header-transparent";
		}
		...
		?>
		<header id="masthead" class="site-header <?php echo esc_attr( $theme_options_data['thim_header_style'] ); ?> <?php echo $border_header ?> <?php echo esc_attr( $theme_options_data['thim_header_position'] ); ?><?php echo esc_attr( $class_transparent ); ?>" role="banner">
			<?php
			// show top header
